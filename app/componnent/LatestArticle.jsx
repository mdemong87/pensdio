        ...
        <div className="h-auto pt-8 pb-20 sBg">
            <Container>
                ...
                <div className="flex flex-col md:flex-row md:gap-8 mt-10">
                    <HomeLatestArticalCard image={ArticleOne} tophead={'UI/UX Design'} head={'Crafting Engaging and User-centric Digital Experiences'} min={'10 min'} />
                    <HomeLatestArticalCard image={Articletwo} tophead={'Branding'} head={'Six Secret Powers of Effective Social Media Ad Design & Branding'} min={'9 min'} />
                    <HomeLatestArticalCard image={Articlethree} tophead={'Motion Design'} head={'Proven 7 Benefits of Motion Design for Business Owners 2023'} min={'10 min'} />
                </div>
                <div className="mt-10">
